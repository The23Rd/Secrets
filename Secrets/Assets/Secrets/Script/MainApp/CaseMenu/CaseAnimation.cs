...
namespace Studio23rd.Secrets.Case{
	public class CaseAnimation : MonoBehaviour {
		public GameObject m_CaseObject;
		...
		void ResetAsInit ()
		{
			...
			m_ThickRing01.transform.localScale = m_ThickRing02.transform.localScale = Vector3.one;
			m_Ring01.transform.localScale = m_Ring02.transform.localScale = Vector3.one;
		...
		IEnumerator QuitCoroutine ()
		{
			...
			yield return new WaitForSeconds (1f);
			m_Ring02.transform.DOScale (1, 0.5f).SetEase (Ease.OutBack);
			m_Ring01.transform.DOScale (1, 0.5f).SetEase (Ease.OutBack).SetDelay (0.2f);
			m_ThickRing02.transform.DOScale (1,0.5f).SetEase (Ease.OutBack).SetDelay (0.4f);
			m_ThickRing01.transform.DOScale (1, 0.5f).SetEase (Ease.OutBack).SetDelay (0.6f);
